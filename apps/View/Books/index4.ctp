...
Trong file BooksController.php mình có đặt tên là public $name = “Books”;
và trong Book.php có đặt tên var $name = “Book”;
việc chọn var hay public đều được ở phiên bản PHP từ 5.1.3 trở lên,
nếu sử dụng var ở phiên bản PHP trước 5.1.3 sẽ có cảnh báo.
